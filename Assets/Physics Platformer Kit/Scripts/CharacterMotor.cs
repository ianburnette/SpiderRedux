...
public class CharacterMotor : MonoBehaviour 
{
	...
	public virtual bool MoveTo(Vector3 destination, float acceleration, float stopDistance, bool ignoreY)
	{
//print("moving to " + destination);
	...
	public virtual void RotateToDirection(Vector3 lookDir, float turnSpeed, bool ignoreY)
	{
    ...
    public virtual void ManageSpeed(float deceleration, float maxSpeed, bool ignoreY)
	{	
